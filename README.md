...
2) converts SLiM outputs into VCF files with custom python scripts (see "Python scripts")
3) computes nucleotide diversity using custom python scripts (see "Python scripts")
...
-** **: plots mean relatedness between males and between females and male and female effective sizes for each scenario.
